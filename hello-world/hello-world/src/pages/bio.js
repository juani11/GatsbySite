...
const scrollToRef = (ref) => window.scrollTo({ behavior: "smooth",top: ref.current.offsetTop -90})   
...
const Bio = () => {
    ...
    return (
        ...
        <div ref={refBio} className="container" id="Bio" style={{ maxWidth: "1250px", marginTop: "50px" }}>
            <section>
